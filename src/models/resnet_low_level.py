...
#sys.path.insert(0, './unsupervised_resnet_pretrained_model/')
import training
...
def resnet18(pretrained=False, path_unsup=None, **kwargs):
    ...
    if pretrained:
        if path_unsup is not None:
            print("RESNET 18 low level")
            print("resnet_low_level: Loading Unsupervised Pretraining weights...")
