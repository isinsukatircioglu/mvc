class BoundingBox:
    ...
    def _compute_bounding_box(self, points_2d):
        ...
        rect_length_width =  width
        rect_length_height = height
        frame_margin_width = int(rect_length_width * self.margin)
        frame_margin_height = int(rect_length_height * self.margin)
        rect_length_width += frame_margin_width
        rect_length_height += frame_margin_height

        bbox_y = min_y - int(frame_margin_height / 2)
        bbox_x = min_x - int(frame_margin_width / 2)

        return [bbox_x, bbox_y, rect_length_width, rect_length_height]
